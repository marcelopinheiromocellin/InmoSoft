...
class HistoricoFuncionarioPage extends StatefulWidget {
  HistoricoFuncionarioPage({Key key}) : super(key: key);

  @override
  _HistoricoFuncionarioPageState createState() =>
      _HistoricoFuncionarioPageState();
}

class _HistoricoFuncionarioPageState extends State<HistoricoFuncionarioPage> {
  ...
  bool loading = false;
  File file;
  String filtroSeleccionado = 'ID_FUNCIONARIO';
  String orderBySeleccionado = 'ID_FUNCIONARIO';
  ...
  writeData(String data) async {
    ...
    _localPath.then((dir) async {
      await File('$dir/ReporteFuncionario.pdf')
          .writeAsBytes(bytes)
          .then((file) async {
        await PDFDocument.fromFile(file).then((value) {
          Get.to(PDFView(document: value, title: "Reporte de funcionarios", file: file));
  ...
  Widget build(BuildContext context) {
    ...
    void loadPDF() {
      setState(() {
        ...
        if (filtroSeleccionado == 'ID_FUNCIONARIO') {
          condition +=
              " and f.id_funcionario between '${desde.text}' and '${hasta.text}'";
        }
        if (filtroSeleccionado == 'Nombre') {
          condition +=
              " and f.nombre between '${desde.text}' and '${hasta.text}'";
        }
        if (filtroSeleccionado == 'Apellido') {
          condition +=
              " and f.apellido between '${desde.text}' and '${hasta.text}'";
        }
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Reporte Funcionario"),
        centerTitle: true,
      ),
      body: SafeArea(
